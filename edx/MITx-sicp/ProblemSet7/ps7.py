...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        direct = self.getRobotDirection()
        new_pos = pos.getNewPosition(direct, self.speed)
...
#showPlot1("Plot1", "plot1_x", "plot1_y")
...
showPlot2("Plot2", "plot2_x", "plot2_y")